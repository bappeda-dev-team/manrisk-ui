            ...
            <table className="w-full">
                <thead>
                    <tr className="text-white bg-gray-700">
                        ...
                        <th rowSpan={2} className="border-r border-b py-4 px-6 border-gray-300 min-w-[300px] text-center">Rencana Waktu Pelaksanaan Perlakuan Risiko</th>
                        <th rowSpan={2} className="border-r border-b py-4 px-6 border-gray-300 min-w-[200px] text-center">Realisasi Waktu Pelaksanaan Perlakuan Risiko</th>
                        ...
                        <th rowSpan={2} className="border-r border-b py-4 px-6 border-gray-300 min-w-[200px] text-center">Tingkat Risiko(Dampak X Kemungkinan)</th>
