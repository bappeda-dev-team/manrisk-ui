                    ...
                    <tbody>
                        <React.Fragment>
                            <tr>
                                ...
                                <td className="border border-cyan-600 px-6 py-4">Rekin Strategic OPD</td>
                                ...
                                <td className="border border-cyan-600 px-6 py-4">Pernyataan Risiko</td>
                                ...
                                <td className="border border-cyan-600 px-6 py-4">Apakah Risiko Dapat Terkendali dengan baik</td>
                                <td className="border border-cyan-600 px-6 py-4">Bagaimana Dampaknya</td>
