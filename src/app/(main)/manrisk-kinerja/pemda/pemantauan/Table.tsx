                ...
                <table className="w-full">
                    <thead>
                        <tr className="text-white bg-gray-700">
                            ...
                            <th className="border-r border-b py-4 px-6 border-gray-300 min-w-[200px] text-center">Perangkat Daerah Yang Menangani</th>
                    ...
                    <tbody>
                        <React.Fragment>
                            ...
                            <tr>
                                ...
                                <td className="border border-gray-700 px-6 py-4">Perangkat Daerah Yang Menangani</td>
