                    ...
                    <tbody>
                        <React.Fragment>
                            ...
                            <tr>
                                ...
                                <td rowSpan={3} className="border border-green-500 px-6 py-4">Nama Level 4</td>
                                ...
                                <td rowSpan={3} className="border border-green-500 px-6 py-4">Rekin Strategic Pemda</td>
                                <td></td><td></td>
